  ...
  return (
    <div>
      <div className="p-6 mt-10 text-center font-sans">
        ...
        <select
          className="mr-8 rounded-md px-4 border-slate-400 focus:border-teal-400 border-[2px] focus:outline-none text-xl"
          name="searchType"
          id="searchType"
          value={searchType}
          onChange={HandleOptionValue}
        >
          <option className="text-xl font-extralight bg-slate-300 " value="name">Name</option>
          <option className="text-xl font-extralight bg-slate-300 " value="cuisine">Cuisine</option>
          <option className="text-xl font-extralight bg-slate-300 " value="ingredient">Ingredient</option>
          <option className="text-xl font-extralight bg-slate-300 " value="category">Category</option>
        </select>
        <input
      ...
      {!isLoading && !recipe && (
        <div className="text-center text-xl font-thin font-sans ">
          <p>Sorry ! No Results found</p>
        </div>
      )}
      <div className="grid grid-cols-3 gap-24 px-6">
        {recipe &&
          recipe.map((meal) => {
            return (
              <Recipe
