    ...
    <div>
      <div className="mx-16 my-12 md:text-left text-center">
        ...
        <p className="font-serif text-slate-500 tracking-wide leading-8 text-xl my-4">
          ...
          you in creating delicious meals that satisfy your cravings. We have
          curated a vast collection of recipes spanning various cuisines,
          flavors, and dietary preferences. From mouthwatering appetizers to
          delectable main courses and indulgent desserts, our recipe database
          offers a diverse range of options to suit every palate. To power our
          recipe website, we rely on the MealDB API. The MealDB API is a
          comprehensive and reliable source of culinary data that provides us
          with access to an extensive catalog of recipes, ingredients, and
          measurements. This integration allows us to present you with accurate
        ...
        <p className="font-serif text-slate-500 tracking-wide leading-8 text-xl my-4">
          ...
          journey. We hope you enjoy using our recipe website and discover new
          culinary delights that bring joy to your kitchen and dining table.
          Happy cooking!
        </p>
      </div>
    </div>
